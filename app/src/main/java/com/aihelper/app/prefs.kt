...
object Keys { val SERVER = stringPreferencesKey("server"); val GATEWAY = stringPreferencesKey("gateway"); val PROXY_TYPE = intPreferencesKey("proxy_type"); val PROXY_HOST = stringPreferencesKey("proxy_host"); val PROXY_PORT = intPreferencesKey("proxy_port"); val PROXY_USER = stringPreferencesKey("proxy_user"); val PROXY_PASS = stringPreferencesKey("proxy_pass"); val LAST_SYNC_TODO = longPreferencesKey("last_sync_todo"); val LAST_SYNC_MSG = longPreferencesKey("last_sync_msg"); val CERT_PIN_HOST = stringPreferencesKey("cert_pin_host"); val CERT_PIN_SHA256 = stringPreferencesKey("cert_pin_sha256"); val TRUST_CUSTOM_CA = intPreferencesKey("trust_custom_ca") }
